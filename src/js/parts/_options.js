...
const options = {
    ...
    templates: {
        ...
        cookieAlert:
            ...
            This site uses cookies to track usage and logs a limited amount of user data. By clicking confirm, you consent to the use of cookies and this tracking. <a href="#">Cookie policy</a>.
